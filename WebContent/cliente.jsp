	...
	<div class="container-fluid">
		...
		<div class="ls-txt-right">
			<button data-ls-module="modal" data-target="#myAwesomeModal"
				...
				<span class="ls-ico-user-add"> </span> Cadastrar novo cliente
			</button>
		</div>
		<!-- Grid de registros -->
		<div id="containerTbl">
				...
				<div class="ls-modal-body">
					<fieldset>
						<label class="ls-label col-md-4 col-xs-12"> <b
							class="ls-label-text">CPF (Somente Números)</b> <input type="text" onfocusout="validaCampoCpf(this, false)" name="cpf" placeholder="00000000000" maxlength="11">
						</label> <label class="ls-label col-md-4 col-xs-12"> <b
							class="ls-label-text">Nome</b> <input type="text" name="nome"
							placeholder="Nome completo" class="ls-field" required>
						</label>
						<label class="ls-label col-md-4 col-xs-12"> <b
							class="ls-label-text">Saldo</b>
							<div class="ls-prefix-group">
								<span class="ls-label-text-prefix">R$</span>
								<input type="text" name="saldo" onfocusout="Movimentos.onlyNumbers(this)" class="ls-field" required>
							</div>
						</label> 
					</fieldset>
				...
				<div class="ls-modal-body">
					...
					<label class="ls-label col-md-4 col-xs-12"> <b
						...
						<label class="ls-label col-md-4 col-xs-12"> <b class="ls-label-text">Saldo</b>
							<div class="ls-prefix-group">
								<span class="ls-label-text-prefix">R$</span>
								<input type="text" name="saldo" id="saldo" onfocusout="Movimentos.onlyNumbers(this)" class="ls-field" required>
							</div>
						</label> 
					</fieldset>
				</div>
