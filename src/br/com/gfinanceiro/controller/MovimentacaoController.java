			...
			if (acao.equals("listar")) {
				...
				if (request.getParameter("cpf_cnpj") != null) {
					...
					if( cpf_cnpj.length() == 11 ){
						...
						String arrayJsonRetornoCliente = objDaoCliente.getClientePorCpf(cpf_cnpj);
						response.getWriter().print(arrayJsonRetornoCliente);
						
						
					}else if( cpf_cnpj.length() == 14 ){
						
						String arrayJsonRetornoFornecedor = objDaoFornecedor.getFornecedorPorCnpj(cpf_cnpj);
